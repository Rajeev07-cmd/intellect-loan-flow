            ...
            <div className="flex items-center gap-4 relative flex-1">
                  ...
                  {searchResults.length > 0 ? (
                    searchResults.map(app => (
                      ...
                      >
                        ...
                        <p className="text-[10px] text-muted-foreground">{app.id.slice(0, 8)} • {app.sector} • ₹{app.loanAmount} Cr</p>
                      </button>
                    ))
                  ) : (
              ...
              <div className="hidden lg:block relative">
                <button
                  ...
                  className="flex items-center gap-2 rounded-xl border border-border/40 bg-muted/30 px-3 py-1.5 text-xs font-medium text-foreground hover:border-primary/30 transition-colors max-w-[280px]"
                >
                  ...
                  {selectedApplication && (
                    <span className="text-[9px] text-muted-foreground shrink-0">
                      ₹{selectedApplication.loanAmount} Cr
                    </span>
                  )}
                  {loadingApps ? (
...
function AppSelectorItem({ app, selected, onSelect }: { app: CompanyApplication; selected: boolean; onSelect: (app: CompanyApplication) => void }) {
  return (
    <button
